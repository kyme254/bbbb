...
$can_add = ACL::is_allowed("members/add");
$can_edit = ACL::is_allowed("members/edit");
$can_view = ACL::is_allowed("members/view");
$can_delete = ACL::is_allowed("members/delete");
?>
<?php
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-relationship">
                                        <th class="title"> Relationship: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $relationship2); ?>' 
                                                data-value="<?php echo $data['relationship']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("members/editfield/" . urlencode($data['id'])); ?>" 
