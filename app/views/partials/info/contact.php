		...
		<div class="row">
			...
			<div class="col-sm-7">
				<div class="panel panel-body">
					...
					<p>
						<b class="chead"><span class="material-icons"></span>Nairobi | Huruma</b><br />
						<p class="adr clearfix">
							<span class="adr-group">
								<span class="street-address">Church Location Address</span><br>
								<span class="postal-code">P.O. Box 1111</span><br>
								<span class="country-name">Huruma, Nairobi Kenya</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent"> +254746797197 / +254746797197</span>
					</p>
					<hr />

					<p>
						<b class="chead"><span class="material-icons"></span> Email</b><br />
						<a href="#" class="editContent">church@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
