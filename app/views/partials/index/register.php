                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-relationship"  value="<?php  echo $this->set_field_value('relationship',""); ?>" type="text" placeholder="Enter Relationship"  required="" name="relationship"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        <input id="ctrl-join_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('join_date',""); ?>" type="datetime" name="join_date" placeholder="Enter Join Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
