...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.birthday LIKE ? OR 
				users.relationship LIKE ? OR 
				users.join_date LIKE ? OR 
				users.role LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("fullname","email","phone","address","birthday","relationship","join_date","role","username","password","account_status");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","fullname","phone","address","birthday","relationship","join_date","role","username","account_status");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'fullname' => 'required',
