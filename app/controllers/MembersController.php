...
class MembersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				members.id LIKE ? OR 
				members.firstname LIKE ? OR 
				members.middle_name LIKE ? OR 
				members.lastname LIKE ? OR 
				members.phone LIKE ? OR 
				members.gender LIKE ? OR 
				members.birthday LIKE ? OR 
				members.residence LIKE ? OR 
				members.email LIKE ? OR 
				members.relationship LIKE ? OR 
				members.photo LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("firstname","middle_name","lastname","phone","gender","birthday","residence","email","relationship","photo","username","password");
			...
			$this->sanitize_array = array(
				...
				'residence' => 'sanitize_string',
				'email' => 'sanitize_string',
				'relationship' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","firstname","middle_name","lastname","phone","gender","birthday","residence","email","relationship","photo","username","password");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
